...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-background text-text-primary flex">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto aqua-scrollbar">
        {/* 2. TOP NAVIGATION */}
        <Navbar
          onMenuClick={() => setSidebarOpen(true)}
          user={{ name: 'Rajesh Kumar', role: 'BlueWave Aqua Farm' }}
          searchSlot={
            <SearchBar
              value={searchQuery}
        ...
        <main className="p-4 sm:p-6 lg:p-8 space-y-8">
          ...
          {/* 7. RECENT ACTIVITIES & 8. UPCOMING REMINDERS */}
